...
namespace GameMain
{
    public static class EntityExtension
    {
        ...
        public static void ShowSquare(this EntityComponent entityComponent, SquareData data)
        {
            entityComponent.ShowEntity(typeof(Square), "Square", Constant.AssetPriority.EffectAsset, data);
        }
